...
public class Lua_MyLuaSrv : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int CallReceiveProtol(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			var ret=self.CallReceiveProtol(a1,a2,a3,a4,a5);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SDispose_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int MonoGC_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ClearLuaMapAsset_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public int get_IsRunning(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,MyLuaSrv.IsRunning);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,CallReceiveProtol);
		addMember(l,LuaManualGC);
		addMember(l,SDispose_s);
		addMember(l,GetFullPath_s);
		addMember(l,MonoGC_s);
		addMember(l,ClearLuaMapAsset_s);
		addMember(l,getItem);
		addMember(l,setItem);
		...
		addMember(l,"IsRunning",get_IsRunning,null,false);
		addMember(l,"LuaStateMemory",get_LuaStateMemory,null,true);
		createTypeMetatable(l,null, typeof(MyLuaSrv));
	}
}
