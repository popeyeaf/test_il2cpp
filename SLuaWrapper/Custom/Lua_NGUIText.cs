...
public class Lua_NGUIText : LuaObject {
	...
	static public int EncodeColor_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function EncodeColor to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int ParseSymbol_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function ParseSymbol to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int WrapText_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				checkType(l, 1, out a1);
				System.String a2;
				var ret=NGUIText.WrapText(a1,out a2);
				pushValue(l,true);
				pushValue(l,ret);
				pushValue(l,a2);
				return 3;
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function WrapText to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
