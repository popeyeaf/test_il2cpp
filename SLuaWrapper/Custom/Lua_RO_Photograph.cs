...
public class Lua_RO_Photograph : LuaObject {
	...
	static public int Enter(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			RO.Photograph self=(RO.Photograph)checkSelf(l);
			RO.PhotographMode a1;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_forceRotation(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			RO.Photograph self=(RO.Photograph)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.forceRotation);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_forceRotation(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_useForceRotation(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			RO.Photograph self=(RO.Photograph)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.useForceRotation);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_useForceRotation(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.Photograph");
		addMember(l,Enter);
		addMember(l,Exit);
		addMember(l,"cameraController",get_cameraController,set_cameraController,true);
		addMember(l,"forceRotation",get_forceRotation,set_forceRotation,true);
		addMember(l,"useForceRotation",get_useForceRotation,set_useForceRotation,true);
		addMember(l,"running",get_running,null,true);
		addMember(l,"ready",get_ready,null,true);
		addMember(l,"mode",get_mode,null,true);
		createTypeMetatable(l,constructor, typeof(RO.Photograph));
	}
}
