...
public class Lua_System_Collections_Generic_Dictionary_2_int_string : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(IEnumerable<KeyValuePair<System.Int32,System.String>>))){
				System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<System.Int32,System.String>> a1;
				checkType(l, 2, out a1);
				o=new System.Collections.Generic.Dictionary<System.Int32,System.String>(a1);
				pushValue(l,true);
				pushValue(l,o);
			...
			else if(matchType(l,argc,2,typeof(IEnumerable<KeyValuePair<System.Int32,System.String>>),typeof(IEqualityComparer<System.Int32>))){
				System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<System.Int32,System.String>> a1;
				checkType(l, 2, out a1);
				System.Collections.Generic.IEqualityComparer<System.Int32> a2;
				checkType(l, 3, out a2);
	...
	static public int TrimExcess(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function TrimExcess to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
