...
public class Lua_RO_AudioAutoDestroy : LuaObject {
	...
	static public int Destroy(IntPtr l) {
		try {
			...
			#endif
			RO.AudioAutoDestroy self=(RO.AudioAutoDestroy)checkSelf(l);
			self.Destroy();
			pushValue(l,true);
			return 1;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_resID(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_resID(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_resPath(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.AudioAutoDestroy");
		addMember(l,Destroy);
		addMember(l,"resID",get_resID,set_resID,true);
		addMember(l,"resPath",get_resPath,set_resPath,true);
		addMember(l,"source",get_source,set_source,true);
		addMember(l,"OnFinish",null,set_OnFinish,true);
		createTypeMetatable(l,null, typeof(RO.AudioAutoDestroy),typeof(UnityEngine.MonoBehaviour));
	}
}
