...
public class Lua_RO_LuaBehaviour : LuaObject {
	...
	static public int Init(IntPtr l) {
		try {
			...
			#endif
			RO.LuaBehaviour self=(RO.LuaBehaviour)checkSelf(l);
			self.Init();
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.LuaBehaviour");
		addMember(l,Init);
		...
		createTypeMetatable(l,null, typeof(RO.LuaBehaviour),typeof(FLEventDispatcherMono));
	}
}
