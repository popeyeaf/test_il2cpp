...
public class Lua_RO_UIGridEx : LuaObject {
	...
	static public int GetChildList(IntPtr l) {
		try {
			...
			#endif
			RO.UIGridEx self=(RO.UIGridEx)checkSelf(l);
	...
	static public int SortByName_s(IntPtr l) {
		try {
			...
			var ret=RO.UIGridEx.SortByName(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int SortHorizontal_s(IntPtr l) {
		try {
			...
			UnityEngine.Transform a2;
			checkType(l, 2, out a2);
			var ret=RO.UIGridEx.SortHorizontal(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int SortVertical_s(IntPtr l) {
		try {
			...
			UnityEngine.Transform a2;
			checkType(l, 2, out a2);
			var ret=RO.UIGridEx.SortVertical(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(RO.UIGridEx),typeof(UnityEngine.MonoBehaviour));
	}
}
