...
public class Lua_RO_RectObject : LuaObject {
	...
	static public int Contains(IntPtr l) {
		try {
			...
			#endif
			RO.RectObject self=(RO.RectObject)checkSelf(l);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int PlaceTo(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.RectObject");
		addMember(l,Contains);
		addMember(l,PlaceTo);
		addMember(l,"rect",get_rect,set_rect,true);
		addMember(l,"offset",get_offset,set_offset,true);
		addMember(l,"size",get_size,set_size,true);
		createTypeMetatable(l,null, typeof(RO.RectObject),typeof(UnityEngine.MonoBehaviour));
	}
}
