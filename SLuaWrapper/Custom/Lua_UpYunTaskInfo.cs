...
public class Lua_UpYunTaskInfo : LuaObject {
	...
	static public int get_id(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			UpYunTaskInfo self=(UpYunTaskInfo)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.id);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UpYunTaskInfo));
	}
}
