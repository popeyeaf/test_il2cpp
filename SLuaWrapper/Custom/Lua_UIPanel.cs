...
public class Lua_UIPanel : LuaObject {
	...
	static public int IsVisible(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function IsVisible to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int ConstrainTargetToBounds(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function ConstrainTargetToBounds to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Find_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Find to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
