...
public class Lua_RO_AnimatorPlayer_Params : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			RO.AnimatorPlayer.Params o;
			o=new RO.AnimatorPlayer.Params();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_stateName(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			RO.AnimatorPlayer.Params self=(RO.AnimatorPlayer.Params)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.AnimatorPlayer.Params");
		...
		createTypeMetatable(l,constructor, typeof(RO.AnimatorPlayer.Params));
	}
}
