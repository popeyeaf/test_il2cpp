...
public class Lua_RO_RenderQByUI : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int TestExcute(IntPtr l) {
		try {
			#if DEBUG
			...
			#endif
			RO.RenderQByUI self=(RO.RenderQByUI)checkSelf(l);
			self.TestExcute();
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.RenderQByUI");
		addMember(l,TestExcute);
		addMember(l,AddChild);
		addMember(l,"excute",get_excute,set_excute,true);
		addMember(l,"RenderQ",get_RenderQ,set_RenderQ,true);
		createTypeMetatable(l,null, typeof(RO.RenderQByUI),typeof(UnityEngine.MonoBehaviour));
	}
}
