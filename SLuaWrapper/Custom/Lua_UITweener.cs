...
public class Lua_UITweener : LuaObject {
	...
	static public int SetOnFinished(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetOnFinished to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int AddOnFinished(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddOnFinished to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Begin_s(IntPtr l) {
		try {
			...
			var ret=UITweener.Begin<UITweener>(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
