...
public class Lua_UILabel : LuaObject {
	...
	static public int GetCharacterIndexAtPosition(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetCharacterIndexAtPosition to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int GetWordAtPosition(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetWordAtPosition to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int GetUrlAtPosition(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetUrlAtPosition to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Wrap(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Wrap to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UILabel),typeof(UIWidget));
	}
}
