...
public class Lua_RO_RoleFollowManager : LuaObject {
	...
	static public int ClearInfoPool(IntPtr l) {
		try {
			...
			#endif
			RO.RoleFollowManager self=(RO.RoleFollowManager)checkSelf(l);
			self.ClearInfoPool();
			pushValue(l,true);
			return 1;
		}
	...
	static public int RegisterFollow(IntPtr l) {
		try {
			...
			System.Action<UnityEngine.Transform,System.Object> a6;
			checkDelegate(l,7,out a6);
			System.Object a7;
			checkType(l, 8, out a7);
			self.RegisterFollow(a1,a2,a3,a4,a5,a6,a7);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int RegisterFollowCP(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Object a5;
			checkType(l, 6, out a5);
			self.RegisterFollowCP(a1,a2,a3,a4,a5);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_Instance(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,RO.RoleFollowManager.Instance);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.RoleFollowManager");
		...
		createTypeMetatable(l,null, typeof(RO.RoleFollowManager),typeof(RO.SingleTonGO<RO.RoleFollowManager>));
	}
}
