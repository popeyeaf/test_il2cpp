...
public class Lua_WAVHelper : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_LeftChannel(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			WAVHelper self=(WAVHelper)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.LeftChannel);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_RightChannel(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WAVHelper");
		addMember(l,GetBytes_s);
		addMember(l,"LeftChannel",get_LeftChannel,null,true);
		addMember(l,"RightChannel",get_RightChannel,null,true);
		...
		createTypeMetatable(l,constructor, typeof(WAVHelper));
	}
}
