...
public class Lua_RO_GradientUISprite : LuaObject {
	...
	static public int OnFill(IntPtr l) {
		try {
			...
			#endif
			RO.GradientUISprite self=(RO.GradientUISprite)checkSelf(l);
	...
	static public int set_dir(IntPtr l) {
		try {
			...
			#endif
			RO.GradientUISprite self=(RO.GradientUISprite)checkSelf(l);
			RO.GradientUISprite.GradientDirection v;
			checkEnum(l,2,out v);
			self.dir=v;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.GradientUISprite");
		addMember(l,OnFill);
		...
		createTypeMetatable(l,null, typeof(RO.GradientUISprite),typeof(UISprite));
	}
}
