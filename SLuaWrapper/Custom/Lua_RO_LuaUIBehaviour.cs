...
public class Lua_RO_LuaUIBehaviour : LuaObject {
	...
	static public int get_layer(IntPtr l) {
		try {
			...
			#endif
			RO.LuaUIBehaviour self=(RO.LuaUIBehaviour)checkSelf(l);
			pushValue(l,true);
			pushEnum(l,(int)self.layer);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.LuaUIBehaviour");
		addMember(l,"layer",get_layer,set_layer,true);
		addMember(l,"lua",get_lua,set_lua,true);
		createTypeMetatable(l,null, typeof(RO.LuaUIBehaviour),typeof(RO.LuaBehaviour));
	}
}
