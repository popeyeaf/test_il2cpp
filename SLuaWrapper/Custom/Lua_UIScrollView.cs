...
public class Lua_UIScrollView : LuaObject {
	...
	static public int RestrictWithinBounds(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function RestrictWithinBounds to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int UpdateScrollbars(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function UpdateScrollbars to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
