...
public class Lua_RO_RotateSelf : LuaObject {
	...
	static public int get_space(IntPtr l) {
		try {
			...
			#endif
			RO.RotateSelf self=(RO.RotateSelf)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(RO.RotateSelf),typeof(UnityEngine.MonoBehaviour));
	}
}
