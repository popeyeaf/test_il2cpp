...
public class Lua_DUTask : LuaObject {
	...
	static public int SetCallBacks(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			DUTask self=(DUTask)checkSelf(l);
			System.Action<System.Int32> a1;
			checkDelegate(l,2,out a1);
			System.Action<DUError> a2;
			checkDelegate(l,3,out a2);
			System.Action<DUTask,System.Single,System.Single> a3;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int Running(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_clonedTimes(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_clonedTimes(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"clonedTimes",get_clonedTimes,set_clonedTimes,true);
		createTypeMetatable(l,constructor, typeof(DUTask));
	}
}
