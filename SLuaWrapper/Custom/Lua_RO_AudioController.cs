...
public class Lua_RO_AudioController : LuaObject {
	...
	static public int Stop(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			RO.AudioController self=(RO.AudioController)checkSelf(l);
			self.Stop();
			pushValue(l,true);
			return 1;
		}
