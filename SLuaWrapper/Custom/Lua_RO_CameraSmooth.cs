...
public class Lua_RO_CameraSmooth : LuaObject {
	...
	static public int Destroy(IntPtr l) {
		try {
			...
			#endif
			RO.CameraSmooth self=(RO.CameraSmooth)checkSelf(l);
			self.Destroy();
			pushValue(l,true);
			return 1;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int CreateT_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			var ret=RO.CameraSmooth.CreateT<RO.CameraSmooth>(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int set_listener(IntPtr l) {
		try {
			...
			#endif
			RO.CameraSmooth self=(RO.CameraSmooth)checkSelf(l);
			System.Action<RO.CameraController> v;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"RO.CameraSmooth");
		addMember(l,Destroy);
		addMember(l,Reset);
		addMember(l,End);
		addMember(l,Update);
		addMember(l,CreateT_s);
		...
		createTypeMetatable(l,null, typeof(RO.CameraSmooth));
	}
}
