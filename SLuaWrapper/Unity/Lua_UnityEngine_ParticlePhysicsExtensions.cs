	...
	static public int GetTriggerParticles_s(IntPtr l) {
		try {
			...
			if(argc==3){
				...
				System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> a3;
				checkType(l, 3, out a3);
				UnityEngine.ParticleSystem.ColliderData a4;
				var ret=UnityEngine.ParticlePhysicsExtensions.GetTriggerParticles(a1,a2,a3,out a4);
				pushValue(l,true);
				pushValue(l,ret);
				pushValue(l,a4);
				return 3;
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetTriggerParticles to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
