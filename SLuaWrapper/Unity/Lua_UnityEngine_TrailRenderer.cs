...
public class Lua_UnityEngine_TrailRenderer : LuaObject {
	...
	static public int GetPositions(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(LuaOut))){
				UnityEngine.TrailRenderer self=(UnityEngine.TrailRenderer)checkSelf(l);
				UnityEngine.Vector3[] a1 = default;
				...
				UnityEngine.TrailRenderer self=(UnityEngine.TrailRenderer)checkSelf(l);
				Unity.Collections.NativeArray<UnityEngine.Vector3> a1 = default;
				var ret=self.GetPositions(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
				...
				UnityEngine.TrailRenderer self=(UnityEngine.TrailRenderer)checkSelf(l);
				Unity.Collections.NativeSlice<UnityEngine.Vector3> a1 = default;
				var ret=self.GetPositions(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetPositions to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int AddPositions(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddPositions to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
