...
public class Lua_UnityEngine_Device_Application : LuaObject {
	...
	static public int CanStreamedLevelBeLoaded_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(int))){
				...
				var ret=UnityEngine.Device.Application.CanStreamedLevelBeLoaded(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int GetBuildTags_s(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			var ret=UnityEngine.Device.Application.GetBuildTags();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int GetStackTraceLogType_s(IntPtr l) {
		try {
			...
			var ret=UnityEngine.Device.Application.GetStackTraceLogType(a1);
			pushValue(l,true);
			pushEnum(l,(int)ret);
			return 2;
		}
	...
	static public int HasProLicense_s(IntPtr l) {
		try {
			...
			UnityEngine.Profiling.Profiler.BeginSample(methodName);
			#endif
			var ret=UnityEngine.Device.Application.HasProLicense();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int HasUserAuthorization_s(IntPtr l) {
		try {
			...
			checkEnum(l,1,out a1);
			var ret=UnityEngine.Device.Application.HasUserAuthorization(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int IsPlaying_s(IntPtr l) {
		try {
			...
			checkType(l, 1, out a1);
			var ret=UnityEngine.Device.Application.IsPlaying(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int OpenURL_s(IntPtr l) {
		try {
			...
			System.String a1;
			checkType(l, 1, out a1);
			UnityEngine.Device.Application.OpenURL(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int Quit_s(IntPtr l) {
		try {
			...
			if(argc==0){
				...
				System.Int32 a1;
				checkType(l, 1, out a1);
				UnityEngine.Device.Application.Quit(a1);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
	...
	static public int RequestAdvertisingIdentifierAsync_s(IntPtr l) {
		try {
			...
			var ret=UnityEngine.Device.Application.RequestAdvertisingIdentifierAsync(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int RequestUserAuthorization_s(IntPtr l) {
		try {
			...
			UnityEngine.UserAuthorization a1;
			checkEnum(l,1,out a1);
			var ret=UnityEngine.Device.Application.RequestUserAuthorization(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int SetBuildTags_s(IntPtr l) {
		try {
			...
			UnityEngine.Device.Application.SetBuildTags(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int SetStackTraceLogType_s(IntPtr l) {
		try {
			...
			UnityEngine.Device.Application.SetStackTraceLogType(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_absoluteURL(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.absoluteURL);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_backgroundLoadingPriority(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.Application.backgroundLoadingPriority);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_backgroundLoadingPriority(IntPtr l) {
		try {
			...
			checkEnum(l,2,out v);
			UnityEngine.Device.Application.backgroundLoadingPriority=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_buildGUID(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.buildGUID);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_cloudProjectId(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.cloudProjectId);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_companyName(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.companyName);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_consoleLogPath(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.consoleLogPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_dataPath(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.dataPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_genuine(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.genuine);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_genuineCheckAvailable(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.genuineCheckAvailable);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_identifier(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.identifier);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_installerName(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.installerName);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_installMode(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.Application.installMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_internetReachability(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.Application.internetReachability);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_isBatchMode(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.isBatchMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_isConsolePlatform(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.isConsolePlatform);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_isEditor(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.isEditor);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_isFocused(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.isFocused);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_isMobilePlatform(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.isMobilePlatform);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_isPlaying(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.isPlaying);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_persistentDataPath(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.persistentDataPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_platform(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.Application.platform);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_productName(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.productName);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_runInBackground(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.runInBackground);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_runInBackground(IntPtr l) {
		try {
			...
			bool v;
			checkType(l,2,out v);
			UnityEngine.Device.Application.runInBackground=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_sandboxType(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.Application.sandboxType);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_streamingAssetsPath(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.streamingAssetsPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_systemLanguage(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.Application.systemLanguage);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_targetFrameRate(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.targetFrameRate);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_targetFrameRate(IntPtr l) {
		try {
			...
			int v;
			checkType(l,2,out v);
			UnityEngine.Device.Application.targetFrameRate=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_temporaryCachePath(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.temporaryCachePath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_unityVersion(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.unityVersion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_version(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.Application.version);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Device.Application");
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Device.Application));
	}
}
