...
public class Lua_UnityEngine_QualitySettings : LuaObject {
	...
	/*[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetAllRenderPipelineAssetsForPlatform_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a1;
			checkType(l, 1, out a1);
			List<UnityEngine.Rendering.RenderPipelineAsset> a2;
			checkType(l, 2, out a2);
			UnityEngine.QualitySettings.GetAllRenderPipelineAssetsForPlatform(a1,ref a2);
			pushValue(l,true);
			pushValue(l,a2);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_streamingMipmapsRenderersPerFrame(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.QualitySettings.streamingMipmapsRenderersPerFrame);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_streamingMipmapsRenderersPerFrame(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			int v;
			checkType(l,2,out v);
			UnityEngine.QualitySettings.streamingMipmapsRenderersPerFrame=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		//addMember(l,GetAllRenderPipelineAssetsForPlatform_s);
