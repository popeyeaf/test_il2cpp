...
public class Lua_UnityEngine_Debug : LuaObject {
	...
	/*[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public unsafe int ExtractStackTraceNoAlloc_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a3;
			checkType(l, 3, out a3);
			var ret=UnityEngine.Debug.ExtractStackTraceNoAlloc(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		//addMember(l,ExtractStackTraceNoAlloc_s);
		addMember(l,Log_s);
