...
public class Lua_UnityEngine_Rendering_RendererUtils_RendererListDesc : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(UnityEngine.Rendering.ShaderTagId),typeof(UnityEngine.Rendering.CullingResults),typeof(UnityEngine.Camera))){
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Rendering.ShaderTagId[]),typeof(UnityEngine.Rendering.CullingResults),typeof(UnityEngine.Camera))){
				UnityEngine.Rendering.ShaderTagId[] a1;
	...
	static public int set_stateBlock(IntPtr l) {
		try {
			...
			UnityEngine.Rendering.RendererUtils.RendererListDesc self;
			checkValueType(l,1,out self);
			System.Nullable<UnityEngine.Rendering.RenderStateBlock> v;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.RendererUtils.RendererListDesc),typeof(System.ValueType));
	}
}
