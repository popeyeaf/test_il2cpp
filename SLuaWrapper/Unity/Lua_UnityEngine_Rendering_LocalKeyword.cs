...
public class Lua_UnityEngine_Rendering_LocalKeyword : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(UnityEngine.Shader),typeof(string))){
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.LocalKeyword),typeof(System.ValueType));
	}
}
