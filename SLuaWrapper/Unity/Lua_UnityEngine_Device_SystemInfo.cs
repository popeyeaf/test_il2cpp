...
public class Lua_UnityEngine_Device_SystemInfo : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_supportsAnisotropicFilter(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.supportsAnisotropicFilter);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_maxTexture3DSize(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.maxTexture3DSize);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_maxTextureArraySlices(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.maxTextureArraySlices);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_maxAnisotropyLevel(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.maxAnisotropyLevel);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_computeSubGroupSize(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.computeSubGroupSize);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"supportsAnisotropicFilter",get_supportsAnisotropicFilter,null,false);
		...
		addMember(l,"maxAnisotropyLevel",get_maxAnisotropyLevel,null,false);
