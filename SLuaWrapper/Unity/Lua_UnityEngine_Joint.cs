...
public class Lua_UnityEngine_Joint : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_connectedArticulationBody(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Joint self=(UnityEngine.Joint)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.connectedArticulationBody);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_connectedArticulationBody(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			UnityEngine.Joint self=(UnityEngine.Joint)checkSelf(l);
			UnityEngine.ArticulationBody v;
			checkType(l,2,out v);
			self.connectedArticulationBody=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"connectedArticulationBody",get_connectedArticulationBody,set_connectedArticulationBody,true);
