	...
	static public int SetParticles(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(LuaOut))){
				...
				UnityEngine.ParticleSystem.Particle[] a1 = default;
				...
				UnityEngine.ParticleSystem self=(UnityEngine.ParticleSystem)checkSelf(l);
				Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle> a1 = default;
				self.SetParticles(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(LuaOut),typeof(int))){
				UnityEngine.ParticleSystem self=(UnityEngine.ParticleSystem)checkSelf(l);
				UnityEngine.ParticleSystem.Particle[] a1 = default;
				System.Int32 a2;
			...
			else if(matchType(l,argc,2,typeof(LuaOut),typeof(int),typeof(int))){
				UnityEngine.ParticleSystem self=(UnityEngine.ParticleSystem)checkSelf(l);
				UnityEngine.ParticleSystem.Particle[] a1 = default;
				System.Int32 a2;
				checkType(l, 3, out a2);
