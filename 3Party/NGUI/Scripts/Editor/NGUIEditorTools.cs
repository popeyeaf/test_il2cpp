...
public static class NGUIEditorTools
{
	...
	static bool MakeTextureAnAtlas (string path, bool force, bool alphaTransparency)
	{
			...
			settings.npotScale != TextureImporterNPOTScale.ToNearest)
		{
			...
			if (NGUISettings.trueColorAtlas)
			{
				TextureImporterPlatformSettings platSetting = ti.GetDefaultPlatformTextureSettings ();
				platSetting.format = TextureImporterFormat.ARGB32;
				ti.SetPlatformTextureSettings(platSetting);
...
//			return tex;
	...
	static public string GetSaveableTexturePath (UIAtlas atlas,string specifiedPath = "")
	{
