...
#region Handles
	...
	public static Vector2 PositionHandle2d(int id, Vector2 position, int size)
	{
		...
		Handles.CircleHandleCap(-1, position, Quaternion.identity, width/2,EventType.MouseDown);
	...
	public static float RotationHandle2d(int id, Vector2 position, float rotation, int radius)
	{
		...
		Handles.CircleHandleCap(-1, position, Quaternion.identity, radius,EventType.MouseDown);
