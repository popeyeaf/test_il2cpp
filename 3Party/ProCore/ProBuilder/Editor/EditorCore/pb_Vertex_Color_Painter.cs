	...
	void OnSceneGUI(SceneView scnview)
	{
		...
		*/
 		Handles.color = InnerRingColor;
			Handles.CircleHandleCap(0, handlePosition, handleRotation, brushSize * .2f,EventType.MouseDown);
 		Handles.color = MiddleRingColor;
			Handles.CircleHandleCap(0, handlePosition, handleRotation, brushSize * .5f,EventType.MouseDown);
 		Handles.color = OuterRingColor;		
			Handles.CircleHandleCap(0, handlePosition, handleRotation, brushSize,EventType.MouseDown);
