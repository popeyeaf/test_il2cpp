...
public class pb_Preferences
{
	...
	static void ShortcutEditPanel()
	{
		...
		defaultShortcuts[shortcutIndex].eventModifiers = (EventModifiers)EditorGUI.EnumFlagsField(modifiersInputRect, defaultShortcuts[shortcutIndex].eventModifiers);
